...
class WorkerRepository(WorkerFactory):
    ...
    def ps_update_pair(self, line_id: int, pair_id: int, pallet_type: int, count: int) -> Optional[PalletScheduleLine]:
        ...
        try:
            ...
            # ===========================================
            # ✅ ✅ ONLY FOR pair_index = 0
            # ===========================================
            if pair_index == 0:

                # ✅ update pallet_status for pallets belonging to this line
                cur.execute("""
                ...
                # 🔥 optional: log
                print(f"[SYNC] Updated t_pallet_status for line {l_id} → pallet_type={pallet_type}")
